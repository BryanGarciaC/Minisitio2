...
function mostrarProductos(){
    ...
    listProductos.forEach(element => {
        var tr =  `<tr>
            ...
            <td><button class="btn btn-danger" onclick="deletex(${index})">Eliminar Producto</button> <button class="btn btn-info" onclick="actualizar(${index})">Actualizar Producto</button></td>
        </tr>`;
